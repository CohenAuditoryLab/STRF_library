...
for k=1:NF
    ...
    % [Ravg,Rstd,R05,R01,Rab]=rastercircularxcorr(RASk,Fsd,'y',100);
    
    % fast! call C subprogram    % Yi Zheng, July 2007
    [Ravg,Rstd,R05,R01,Rab]=rastercircularxcorr2(RASk,Fsd,100);  % cxcorr algthim
    % [Ravg,Rstd,R05,R01,Rab]=rastercircularxcorr3(RASk,Fsd,100);
