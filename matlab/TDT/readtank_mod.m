...
%
function [Data] = readtank_mod(TankFileName,BlockNumber,ChannelNumber,ServerName)
...
N = invoke(TTX, 'ReadEventsV', 10000, 'StOff', 0, 0, 0.0, 0.0, 'ALL');

%Data.StimOff = invoke(TTX, 'ParseEvV', 0, N);
Data.StimOff = invoke(TTX, 'ParseEvInfoV', 0, N, 6);
N = invoke(TTX, 'ReadEventsV', 10000, 'StimOn', 0, 0, 0.0, 0.0, 'ALL');
