...
%Data.Delay
N = invoke(TTX, 'ReadEventsV', 10000, 'Dela', 0, 0, 0.0, 0.0, 'ALL');
Data.Delay = invoke(TTX, 'ParseEvInfoV', 0, N, 6);

%Data.SD
N = invoke(TTX, 'ReadEventsV', 10000, 'SD__', 0, 0, 0.0, 0.0, 'ALL');
Data.SD= invoke(TTX, 'ParseEvInfoV', 0, N, 6);

%Data.TF
N = invoke(TTX, 'ReadEventsV', 10000, 'TF__', 0, 0, 0.0, 0.0, 'ALL');
Data.TF = invoke(TTX, 'ParseEvInfoV', 0, N, 6);

%Data.MF1
N = invoke(TTX, 'ReadEventsV', 10000, 'MF1_', 0, 0, 0.0, 0.0, 'ALL');
Data.MF1 = invoke(TTX, 'ParseEvInfoV', 0, N, 6);
...
invoke(TTX, 'ReleaseServer'); %It does free the memory!!!!!!
