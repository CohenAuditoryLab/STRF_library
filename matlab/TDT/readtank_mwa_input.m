...
%
function [Data] = readtank_mwa_input(TankFileName,BlockNumber,ChannelNumber,ServerName)
...
N = invoke(TTX, 'ReadEventsV', 10000000, 'eeNu', ChannelNumber, 0, 0.0, 0.0, 'ALL');
...
N1 = invoke(TTX, 'ReadEventsV', 10000000, 'eeN1', ChannelNumber, 0, 0.0, 0.0, 'ALL');
...
NTrig=invoke(TTX,'ReadEventsV',10000,'PtC0',0,0,0.0,0.0,'ALL');
