%
% function [MTF] = mtfpsychogenerateoptfast(Data,Fsd,tc,FM,GAMMA,TD,OnsetT,Unit)
%
%	FILE NAME 	: MTF PSYCHO OPT GENERATE
...
%                   MTF.tc          - Analysis time constant (msec)
%
%   (C) Monty A. Escabi, March 2009 (Edit Jan 2010)
%
function [MTF] = mtfpsychogenerateoptfast(Data,Fsd,tc,FM,GAMMA,TD,OnsetT,Unit)

%Generating Psycho MTF across multiple tc
for k=1:length(tc)
    [MTF(k)] = mtfpsychogeneratefast(Data,Fsd,tc(k),FM,GAMMA,TD,OnsetT,Unit);
    clc
