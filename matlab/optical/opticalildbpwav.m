...
%
function [X1,X2] = opticalildbpwav(filename,f1,f2,T,RT,ILD,Fs,M)
...
%Filtering Sound
H=bandpass(f1,f2,(f2-f1)/4,Fs,30,'n');
X=ifft(fft(X).*fft(H,length(X)));
