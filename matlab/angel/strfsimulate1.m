%function [timeaxis,freqaxis,STRF1,STRF2,PP,Wo1,Wo2,No1,No2,SPLN]=strfsimulate1(filename,SoundType);
% 
%Funcntion       using different sound and threshold, reconstruct the STRF
%                this program is used with strfsimulate_gui.m together.
%
%Input
%           filename       : STRF file
...
function [X,Y,timeaxis,freqaxis,STRF1,STRF2,PP,Wo1,Wo2,No1,No2,SPLN]=strfsimulate1(filename,sprfile,Nsig,SNR,Tau,SoundType,L);
...
%to reconstruct STRF
clear taxis faxis;
[timeaxis,freqaxis,STRF1,STRF2,PP,Wo1,Wo2,No1,No2,SPLN]=rtwstrfdb_gui(sprfile,0,.1,spet,Trig,Fsd,60,MdB,ModType,SoundType,50,'float');
