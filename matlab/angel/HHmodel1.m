%function [t,Vout,Spike,Vth,Vmax,rate,Gk,Gna,m,n,h]=HHmodel(mode,Noise,Iin,Fs,ratio,G,E)
%
...
function [t,Vout,rate,Spike]=HHmodel1(Iin,Fs,G,E)
%to initialize parameters
if (nargin<1)
    Iin=(7e-6)*ones(160000,1);
    Fs=16 ;
