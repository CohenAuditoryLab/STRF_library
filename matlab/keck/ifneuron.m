%
%function [X,Vm,R,C,sigma_m,sigma_i,sigma_n,sigma_tot]=
%	  ifneuron(Im,Tau,Tref,Vtresh,Vrest,Fs,In,detrendim,detrendin)
%
%   FILE NAME       : IF NEURON
...
%
function [X,Vm,R,C,sigma_m,sigma_i,sigma_n,sigma_tot]=ifneuron(Im,Tau,Tref,Vtresh,Vrest,Fs,In,detrendim,detrendin)
