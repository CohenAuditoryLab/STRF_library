...
%
function [beta0,R0,J0]=integratefirepsthoptim(Im,PSTH1,PSTH2,beta1,beta2,L,Fs,dbeta)
...
%                 
                [Y]=integratefirepsth(beta,Im);
                %
                %R=PSTH-Y;
                %Compute Correlation function between Y and PSTH and
                %subtract from PSTH1 and PSTH2
                
                
                R12=xcorr(PSTH1,PSTH2,100,'coeff');
                Ry2=xcorr(Y,PSTH2,100,'coeff');
                R=R12-Ry2;
                [k l m n ]
...
LB=[0 0 0 -10];
UB=[10 5 4 15];
%[beta0,Rnorm,R0,EXITFLAG,OUTPUT,LAMBDA,J0]=lsqcurvefit('integratefirepsth',beta,Im,PSTH,LB,UB);
J0=-9999;
